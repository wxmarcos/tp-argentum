...
constexpr HelmetTweak kHelmetTweaks[] = {
    ...
    {keys::HUMANO, keys::CASCO_SOMBRERO, {{0,0},  {2,0},  {-2,0},  {2,0}},  100},

    {keys::ELFO,   keys::CASCO_CAPUCHA,  {{0,-1},  {0,-1},  {0,-1},  {0,-1}},  100},
    ...
    {keys::ENANO,  keys::CASCO_SOMBRERO, {{0,0},  {0,1},  {-1,-1},  {1,-1}},  100},
...
HeadAdjust HeadAdjuster::head(const std::string& raza, const std::string& cuerpo,
                              int dir_idx) {
...
HeadAdjust HeadAdjuster::helmet(const std::string& raza, const std::string& casco,
                                int dir_idx) {
