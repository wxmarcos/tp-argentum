...
void SpriteRegistry::register_sprite(const std::string& key,
    ...
    if (loaded) {
        ...
        std::cerr << "[SpriteRegistry] No se pudo cargar: " << relative_path
                  << "\n";
    }
}
...
void SpriteRegistry::load_all() {
    ...
    register_sprite("goblin", "criaturas/goblin.png",
                    make_goblin_sprite_data());
    register_sprite("esqueleto", "criaturas/esqueleto.png",
                    make_esqueleto_sprite_data());
    register_sprite("zombie", "criaturas/zombie.png",
    ...
    register_sprite("banquero", "characters/banquero.png",
                    make_banquero_sprite_data());
    register_sprite("comerciante", "characters/comerciante.png",
                    make_comerciante_sprite_data());
    register_sprite("sacerdote", "characters/sacerdote.png",
                    make_sacerdote_sprite_data());

    register_head("humano", "cabezas/humanoCabezas.png",
                  make_humano_head_data());
