...
EffectData make_resucitar_effect_data() {
    ...
    d.frames = {
        ...
        {276, 0, 93, 95},   {368, 0, 91, 91},  {22, 95, 50, 89},
        {120, 95, 48, 89},  {220, 95, 38, 83}, {318, 95, 37, 82},
        {419, 105, 23, 66},
    };
    return d;
}
...
EffectData make_ataqueBaculoComun_effect_data() {
    ...
    d.frames = {
        ...
        {425, 21, 98, 99},    {13, 178, 101, 94},   {155, 167, 104, 105},
        {292, 177, 95, 95},   {428, 178, 97, 96},   {12, 331, 104, 99},
        {152, 330, 102, 101}, {288, 329, 104, 107}, {424, 328, 106, 115},
