...
bool ClientGameState::is_inventory_open() const { return inventory_open; }

void ClientGameState::toggle_inventory() { inventory_open = !inventory_open; }
