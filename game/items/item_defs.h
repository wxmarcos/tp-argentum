...
constexpr const char* ESPADA = "Espada";
constexpr const char* HACHA = "Hacha";
constexpr const char* MARTILLO = "Martillo";

constexpr const char* VARA_DE_FRESNO = "Vara de fresno";
constexpr const char* FLAUTA_ELFICA = "Flauta elfica";
constexpr const char* BACULO_NUDOSO = "Baculo nudoso";
constexpr const char* BACULO_ENGARZADO = "Baculo engarzado";

constexpr const char* ARCO_SIMPLE = "Arco simple";
constexpr const char* ARCO_COMPUESTO = "Arco compuesto";
