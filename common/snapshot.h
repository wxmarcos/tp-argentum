...
public:
    ...
    static Snapshot entity_move(const std::string& nick, uint16_t x, uint16_t y, uint8_t direction);
    static Snapshot entity_remove(const std::string& nick);

    static Snapshot damage_event(const std::string& attacker, const std::string& target, uint16_t damage, bool critical);
    static Snapshot dodge_event(const std::string& attacker, const std::string& target);
