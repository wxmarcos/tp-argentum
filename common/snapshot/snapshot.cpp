...
const std::string& Snapshot::get_raza() const {
    return raza;
}

const std::string& Snapshot::get_clase() const {
    return clase;
}

uint16_t Snapshot::get_mapa_id() const {
    return mapa_id;
}

uint16_t Snapshot::get_nivel() const {
    return nivel;
}

uint16_t Snapshot::get_vida() const {
    return vida;
}

uint16_t Snapshot::get_vida_max() const {
    return vida_max;
}

uint16_t Snapshot::get_mana() const {
    return mana;
}

uint16_t Snapshot::get_mana_max() const {
    return mana_max;
}

uint32_t Snapshot::get_experiencia() const {
    return experiencia;
}

uint32_t Snapshot::get_oro() const {
    return oro;
}

uint16_t Snapshot::get_constitucion() const {
    return constitucion;
}

uint16_t Snapshot::get_inteligencia() const {
    return inteligencia;
}

uint16_t Snapshot::get_fuerza() const {
    return fuerza;
}

uint16_t Snapshot::get_agilidad() const {
    return agilidad;
}
